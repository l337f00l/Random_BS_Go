...
; If you want to include this warp stuff in levels other than 112, consult ?LevelNumberTable further below
...
;Format: Hex or Dec.
	;These determine which warp the player will take:
		...
		;Level the start wrap points are in.
			?LevelNumberTable
				dw $0112		;>Index 0 (Index 0 * 2)
				dw $0112		;>Index 2 (Index 1 * 2)
				dw $0112		;>Index 4 (Index 2 * 2)
				dw $0112		;>Index 6 (Index 3 * 2)
				dw $0112		;>Index 8 (Index 4 * 2)
				dw $0112		;>Index 10 (Index 5 * 2)
				dw $0112		;>Index 12 (Index 6 * 2)
