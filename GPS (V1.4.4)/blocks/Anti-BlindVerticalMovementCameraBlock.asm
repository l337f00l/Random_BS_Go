...
print "This forces the camera to follow Mario's upward movement when you pass through it, useful for those times that the camera doesn't do so naturally"