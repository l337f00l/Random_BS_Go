...
;sides will set the silver p-switch timer to max, and play the correct sound effect.
;==================================================================================
print "Sets the silver p-switch timer to max, and play the correct sound effect."
db $42
