...
print "Sprites in this block will behave like they're in water, moving and falling slowly. Splash GFX disabled by default. Note that some sprites, like the floating spike ball (A4), apparently still require buoyancy to be enabled in Lunar Magic itself."