...
;; 
;; Therefore the bit arrangment is: --ns csod (- indicates unused bits)
...
db $CE,$CE,$CE,$CE,$EE,$EE,$EE,$EE,$CE,$CE,$CE,$CE,$EE,$EE,$EE,$EE

HeadTilemap:			; the tiles used by the head
db $80,$82,$80,$82,$84,$86,$84,$86,$88,$E4,$88,$E4,$88,$E4,$88,$E4
...
CoverUpXOffset:		; 
db $01,$01,$01,$11	; Fixed masking, SJC (thanks Anas)
...
LDA #$02
STA !extended_num,y
STZ $1779|!Base2,x     ; Fireball fix, added by SJC (thanks KevinM)
