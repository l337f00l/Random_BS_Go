...
; EDITED BY BUCKET
;  - Spawns a Sprite on Death if Configured to do so.

;========================================================================================================================================================================================================================
;=== DEFINES ============================================================================================================================================================================================================
;========================================================================================================================================================================================================================

; Spawns a sprite on death. #$FF means don't spawn anything.
!Sprite_Number_Spawn_On_Death = #$6B
!Sprite_Spawn_Is_Custom = #$00
!Sprite_Spawn_X_Offset = #$00
!Sprite_Spawn_Y_Offset = #$00
!Sprite_Spawn_X_Speed = #$00
!Sprite_Spawn_Y_Speed = #$00
...
RTS
    ...
    .DESTROY
        ...
        ; custom shitty code to spawn a sprite.
        LDA !Sprite_Number_Spawn_On_Death
        CMP #$FF
        BEQ .nospawn

        LDA !Sprite_Spawn_X_Offset
        STA $00
        LDA !Sprite_Spawn_Y_Offset
        STA $01
        LDA !Sprite_Spawn_X_Speed
        STA $02
        LDA !Sprite_Spawn_Y_Speed
        STA $03
        CLC

        LDA !Sprite_Spawn_Is_Custom
        BEQ .normal
        SEC
        .normal
        LDA !Sprite_Number_Spawn_On_Death
