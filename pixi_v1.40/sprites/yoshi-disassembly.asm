...
; Unlike the normal Yoshi included with the baserom, 
; for which a patch is applied, this disassembled Yoshi will still
; have the graphical glitch if you include it alongside baby Yoshi

; To remove idle bounce, find !sprite_speed_x,x on line 327 (using Notepad++) 
; and set LDA #$F0 to LDA #$00. 	
	

; Also note that since Yoshi is two tiles tall, whenever you place
; this sprite in a level, you're placing the TOP tile of Yoshi's body.
; So if you don't have a visual for this sprite (i.e. if you just use the default custom sprite "X"), 
; make sure to place this one tile ABOVE the ground,
; so that Yoshi doesn't clip into the ground.
