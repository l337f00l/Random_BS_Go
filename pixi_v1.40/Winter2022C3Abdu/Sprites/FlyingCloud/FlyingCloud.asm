...
!LeftSide 				= $0010                  ; left edge of the screen
!RightSide 				= $0120                  ; right edge of the screen
!XDist 					= !RightSide-!LeftSide   ; distance between the right and left edges of the screen

!TopScreen 				= $00A0	                ; top edge of the screen
!BottomScreen 			= $01A0	                ; bottom edge of the screen
!YDist 					= !BottomScreen-!TopScreen
;=======================================
; bruh how tf are the "tabs" are spaces. heckin love vscode.
