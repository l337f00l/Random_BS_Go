...
; these are the stripe image tables used for the title screen
; !! This is for advanced use, make sure you know what you are doing !!
	...
	; and one $FF at the end to indicate the stripe image has ended (E is set in |Byte 1|)
...
org $05B6FE	; Stripe image for the file erase dialogue.
	; empty tiles
	db $50,$85,$40,$2E,!Space
	db $50,$A8,$40,$1C,!Space
	db $50,$C5,$40,$2E,!Space
	db $50,$E8,$40,$1C,!Space
	db $51,$05,$40,$2E,!Space
	db $51,$45,$40,$1C,!Space

	; MARIO A ...EMPTY ($05B722)
	db $50,$8D,$00,$1F
	db !M,!A,!R,!I,!O,!Space,!A,!Space,!Dot,!Dot,!Dot,!E,!M,!P,!T,!Y

	; MARIO B ...EMPTY ($05B746)
	db $50,$CD,$00,$1F
	db !M,!A,!R,!I,!O,!Space,!B,!Space,!Dot,!Dot,!Dot,!E,!M,!P,!T,!Y

	; MARIO C ...EMPTY ($05B76A)
	db $51,$0D,$00,$1F
	db !M,!A,!R,!I,!O,!Space,!C,!Space,!Dot,!Dot,!Dot,!E,!M,!P,!T,!Y
...
org $05B872	; Stripe image for the player select dialogue.
	; empty tiles
	db $50,$85,$40,$2F,!Space
	db $50,$C5,$40,$2F,!Space
	db $51,$05,$40,$2F,!Space
	db $51,$45,$40,$1C,!Space
