...
!Powerup = !Fire    ;  See the options below
...
!StarPower = 0     ; You can also start with star power, on top of the other powerups
                   ; 1 for yes, 0 for no
...
if !StarPower
LDA #$C4         ; Star power timer. C4 is close to normal. 64 is very short. FF is infinite, I think
