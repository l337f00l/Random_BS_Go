; Note: patching this will make you die in the vanilla title screen demo.
; So you'll need to modify the title screen (level C7) if you don't want this to happen.
