...
; After patching this, get GoalTapeMoveLeft.asm from /optional level asm/, put it in /level/ and set to for the level you want.
; 13F is the example level. Simply un-comment out the number in the UberASM list here.
