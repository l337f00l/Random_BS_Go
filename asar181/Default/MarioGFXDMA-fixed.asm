; SJC: fixed incompatibility with Retry
; Still possibly incompatible with Sprite Message Box 
...
!Tile = $0C		;Tile where the extended tiles will be loaded to. Takes up 2 8x8s
			;located in SP1. A.k.a. tiles 40C and 40D in Tile Editor


org $00A304    ; shifted four bytes from 300
...
.skipall
SEP #$20
JML $00A308|!bank    ; shifted four bytes from 304
